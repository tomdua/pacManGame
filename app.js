...
function DefaultLocations(){
	...
	var emptyCell = findRandomEmptyCell(board);
	while((emptyCell[0] === 0 && emptyCell[1] === 0) || (emptyCell[0] === (board_height-1) && emptyCell[1] === (board_width-1)) || (emptyCell[0] === (board_height-1) && emptyCell[1] === 0) || (emptyCell[0] === 0 && emptyCell[1] === (board_width-1)))
